                             ...
                             <div class="comments">
                                ...
                                <div class="d-flex flex-row row mb-2">
                                 <div class="col-12 row">
                                    <div class="col-1" >
                                        <img src="/images/users/{{json_decode($comment->user->image)}}" width="50" height="60" class="rounded-image rounded-circle">
                                    </div>
                                    <div class="border border-dark d-flex justify-content-start align-items-center col-11">
