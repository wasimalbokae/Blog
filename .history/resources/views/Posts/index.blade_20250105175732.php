                    ...
                    <div class="col-6">
                        <div class="card">
                            <div class="row d-flex  justify-content-between p-2 px-3">
                                ...
                                @if (Auth::user())
                                <button class="btn btn-primary cursor-pointer">زر تجريبي</button>

                                <div class=" col-6 text-end d-flex flex-row mt-1 ellipsis">
                                    <small class="col-12 p-2">
                                        <div class="d-flex justify-content-end">
                                            <div class="dropdown cursor-pointer" >
                                                <i class="fas fa-ellipsis-v fs-5 cursor-pointer"  data-bs-toggle="dropdown" aria-expanded="false"></i>
