                        ...
                        <div class="card">
                            <div class="row d-flex  justify-content-between p-2 px-3">
                                <div class="col-4  d-flex align-items-center">
                                    <img src="images/users/{{json_decode($post->users->image)}}" width="50" class="col-12 rounded-circle">
                                    <small class="col-12 align-items-end text-dark text-start">
                                ...
                                <div class=" col-8 text-end d-flex flex-row mt-1 ellipsis">
                            ...
                            <div class="p-2">
                                ...
                                <div class="d-flex justify-content-between align-items-center">
                                    <div class="d-flex flex-row icons d-flex align-items-center"> {{ $total }}   @if($total>1) Comments @else Comment  @endif</div>
