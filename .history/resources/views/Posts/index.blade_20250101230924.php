                    ...
                    <div class="col-md-6  ">
                        <div class="card ">
                            <div class="d-flex justify-content-between p-2 px-3">
                                <div class="d-flex flex-row align-items-center"> <img src="{{$post->user->image }}" width="50" class="rounded-circle">
                            ...
                            {{-- {{$imgs=json_decode($post->image)  as $index=> $img }} --}}

                            <img src="/images/{{json_decode($post->imgs[0])}}" class="img-fluid">
