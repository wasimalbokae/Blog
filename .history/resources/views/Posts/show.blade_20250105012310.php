                    ...
                    <div class="card" id="post_{{$post->id}}">
                        <div class="row d-flex  justify-content-between p-2 px-3">
                            <div class="col-6 row d-flex align-items-start">
                                    ...
                                    <div class="col-12">
                                        <small style="font-size:12px" class="ms-2 align-items-end text-dark text-end">
                                            @if (!empty($post->updated_at))
                                            {{ $post->updated_at->diffForHumans() }}
                                            @endif
                                        </small>
                                    ...
                                    <div class="col-12">
                                        <small style="font-size:15px" class=" ms-2 align-items-end text-primary text-end">
                                            @foreach ($post->tags as $tag)
                                            {{ $tag->word }}
                                            @endforeach
                                        </small>
                             ...
                             <div class="comments">
                                ...
                                <div class="container">
                                    <div class="card d-flex row mb-2 border border-secondary">
                                        <div class="card-body">
                                                <input class="form-control bg-white" value="{{ $comment->content }}" type="text" name="edit_content">
                                                @if(@session('error'))
