                             ...
                             <div class="comments">
                                ...
                                <div class="d-flex flex-row row mb-2">
                                 <div class="col-12 row">
                                    <div class="col-2" >
                                        <img src="/images/users/{{json_decode($comment->user->image)}}" width="70" height="70" class="rounded-image ">
                                    </div>
                                    <div class="col-10 row ">
                                        <div class="col-12 h-100 border rounded-pill border-dark  d-flex justify-content-center align-items-start ">
                                            <small class="mt-5 bg-danger">{{ $comment->content }} </small>
                                        </div>
                                    </div>
                                 </div>
                                 <div class="col-12 mt-1">
                                    <h6 class="text-break text-wrap font-weight-bold">{{$comment->user->name}}</h6>
                                 </div>
                                 <div class="col-12">
