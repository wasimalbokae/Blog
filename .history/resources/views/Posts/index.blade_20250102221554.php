        ...
        <div class="row">
            ...
            <div class="container mt-3 mb-3 ">
                <div class="row d-flex align-items-center justify-content-center ">
                    <div class="col-md-6">
                        <div class="card">
                            <div class="col-12 d-flex justify-content-between p-2 px-3">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="col-6 d-flex flex-column ml-2">
                                        ...
                                        <small class="col-12 align-items-end text-primary text-start">{{$post->title}}</small>
                                    </div>
                                </div>
                                <div class="row text-end d-flex flex-row mt-1 ellipsis">
                                    <small class="col-12 mr-2"><button>Edit</button> </small>
                                    <small class="col-12 mr-2">
                            ...
                            <div class="p-2">
                                ...
                                <div class="d-flex justify-content-between align-items-center">
                                    <div class="d-flex flex-row icons d-flex align-items-center"> #tag </div>
                                    <div class="d-flex flex-row muted-color"> <span>2 comments</span> <span class="ml-2">Share</span> </div>
                                </div>
                                <button><i class="bi bi-three-dots-vertical" data-bs-toggle="dropdown" aria-expanded="false">
                                </i> </button>
