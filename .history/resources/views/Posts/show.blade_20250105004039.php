                                          ...
                                          <div class="d-flex justify-content-between">
                                            ...
                                            <form action="{{ route('comments.destroy', ["id_post"=>$post->id,"id"=>$comment->id]) }}" method="POST">
                                                    ...
                                                    @if (Auth::user()->id==$comment->user->id || Auth::user()->id==$post->id_user)
                                                        <button type="submit"  class="text-dark text-decoration-none me-3">
                                                    ...
                                                    @if (Auth::user()->id==$comment->user->id)
                                                        ...
                                                        <button type="submit" formaction="{{ route('comments.edit',$comment->id) }}"  formmethod="POST" class="btn ">edit</button>
                                                    @endif
                                            </form>
