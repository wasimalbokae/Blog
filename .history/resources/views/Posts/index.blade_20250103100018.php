                        ...
                        <div class="card">
                            <div class="row d-flex  justify-content-between p-2 px-3">
                                <div class="col-6 row d-flex align-items-start">
                                        <div class="bg-dark col-12 row">
                                            <div class="col-3">
                                                <img class="rounded-circle" src="images/users/{{json_decode($post->users->image)}}" width="60" >
                                            </div>
                                            <div class="col-9">
                                        ...
                                        <div class="col-12 bg-danger">
                                            <small class="ms-3 align-items-end text-dark text-end">
