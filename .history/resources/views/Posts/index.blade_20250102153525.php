                    ...
                    <div class="col-md-6  ">
                        <div class="card ">
                            <div class="d-flex justify-content-between p-2 px-3">
                                <div class="d-flex flex-row align-items-center"> <img src="images/users/{{json_decode($post->users->image)}}" width="50" class="rounded-circle">
                                    <div class="d-flex flex-column ml-2"> <span class="font-weight-bold">{{$post->users->name}}</span> <small class="text-primary">{{$post->title}}</small> </div>
                                </div>
                                <div class="d-flex flex-row mt-1 ellipsis"> <small class="mr-2">{{$post->timeDifference}} </small> <i class="fa fa-ellipsis-h"></i> </div>
                            </div>
