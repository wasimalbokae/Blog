                        ...
                        <div class="p-2">
                            ...
                            <div class="d-flex justify-content-center align-items-center ">
                             ...
                             <div class="comments">
                                ...
                                <div class="container">
                                    <div class="card d-flex row mb-2 border border-info">
                                        <div class="card-body">
                                          <p>{{ $comment->content }}</p>
                                          <div class="d-flex justify-content-between">
                                            ...
                                            <div class="d-flex flex-row align-items-center text-body">
                                              ...
                                              <p class="small mb-0">Delete</p>
                                              <a href="" class="text-dark">
                                                <i class="fas fa-edit mx-1 " style="margin-top: -0.16rem;"><span class="small mb-0">Update</span></i>
