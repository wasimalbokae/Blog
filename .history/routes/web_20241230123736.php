...
Route::middleware("auth")->group(function(): void
{
    ...
    Route::get( '/tags', [TagController::class, "index"])->name("posts");
    Route::get( '/tags/create', [TagController::class, "create"] )->name("posts.create");
    Route::POST('/tags/store', [TagController::class, "store"] )->name("posts.store");
    Route::get( '/tags/show/id={id?}', [TagController::class, "show"] )->name("posts.show");
    Route::get( '/tags/edit/id={id?}', [TagController::class, "edit"] )->name("posts.edit");
    Route::POST('/tags/update/id={id?}', [TagController::class, "update"] )->name("posts.update");
    Route::get( '/tags/delete/id={id?}', [TagController::class, "destroy"] )->name("posts.delete");
