...
{    use AuthorizesRequests;
    ...
    public function update(Request $request, $id)
    {
        $this->authorize("is_admin",User::class);
            ...
            {
                $request->validate([
                    "title"=>"nullable|different:old_title|unique:categories|min:3|max:50",
                    "description"=>"nullable|different:old_description|min:3|max:100",
                    "image"=>"nullable|different:old_image|mimes:jpeg,jpg,png,gif|max:10000",
                ]);
